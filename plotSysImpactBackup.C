...
void plotSysImpact(string RELEASE){
  ...
  auto dirs_all = mRoot::get_directories( "../2021_UL17_deep2/sys_check/sm/." ); // sys_check/cta/btag/
...
//  }
  ...
  double qv_nominal = getQuantiles("../2021_UL17_deep2/sys_check/sm/expected/expected_sm_theta.root", "sigma_t_ch", 0.5);
