...
int tree_to_hists(string MODE, string RELEASE, string OUTPUT_FILE_NAME, int NBINS, double QCD_norm = -1.0, double QCD_qut = -1.0, string NN_type = "low_level", string data_type = "expected")
{
  ...
  cout << "treeToHists.C, Will use MODE \"" << MODE << "\", RELEASE \"" << RELEASE << "\""
       << ", QCD normalization = " << QCD_norm << endl;
  ...
  if (MODE == "QCD")
  {
    ...
    {
      fill_hist("QCD", NBINS, rmin, rmax, out_file, PREFIX_NTUPLES, FILES_QCD_MC, tree_name, vrule, qcd_weight, excl);
    }
  ...
  else if (MODE == "SM" or MODE == "FCNCtug" or MODE == "FCNCtcg")
  {
    ...
    {
      fill_hist("QCD", NBINS, rmin, rmax, out_file, PREFIX_NTUPLES, FILES_QCD_MC, tree_name, vrule, qcd_selection, excl);
    }
    for (auto channel : channel_other)
    {
    ...
    for (auto systematic : VARIATION_SYS_T2)
    {
      ...
      if (systematic == "Ren" or systematic == "Fac" or systematic == "RenFac" or systematic == "pdf")
      { // Ren, Fac, pdf (split by channels)
        for (auto sys : channel_sys)
        { // Ren/Fac/pdf split for tW, DY, DB, s_ch, t_ch, ttbar
          for (auto channel : channel_other)
          {
            if (channel == sys)
            {
  ...
  else if (MODE == "SM2D")
  {
    ...
    {
      fill_hist_2d("QCD", NBINS, rmin, rmax, &hists_to_save_2d, PREFIX_NTUPLES, FILES_QCD_MC, tree_name, vrule_x, vrule_y, qcd_selection, excl1, excl2);
    }
    for (auto channel : channel_other)
    {
        ...
        { // Ren/Fac/pdf split for tW, DY, DB, s_ch, t_ch, ttbar
          for (auto channel : channel_other)
          {
            if (channel == sys)
            {
              ...
              fill_hist_2d_sys(channel + "_" + systematic + "_" + sys, NBINS, rmin, rmax, &hists_to_save_2d, PREFIX_NTUPLES, FILES_map.at(channel), tree_name, vrule_x, vrule_y, mc_selection, mc_selection, excl1, excl2);
          }
          for (auto channel : channel_wjets)
          {
      ...
      if (fprefix == "JER")
      {
        for (int i = 0; i < JER_SYS_NAMES.size(); i++)
        {
          ...
          for (int j = 0; j < 2; j++)
          {
            ...
            if (MODE == "FCNCtug")
              fill_hist_2d("fcnc_tug_" + sname, NBINS, rmin, rmax, &hists_to_save_2d, PREFIX_NTUPLES, FILES_FCNC_TUG, tree_name, vrule_x, vrule_y, mc_selection + extra_select, excl1, excl2);
            if (MODE == "FCNCtcg")
    ...
    */
    ...
    for (auto hist : hists_to_save)
    {
      ...
      {
        if (hscale->GetBinContent(nbin) <= 0)
          hscale->SetBinContent(nbin, 1.);
      }
      hscale->Write();
    }
    out2d->Close();
    ...
    for (int i = 0; i < hists_to_save.size(); i++)
    {
      ...
      if (std::count(backgrounds.begin(), backgrounds.end(), name))
        drawer->stack_hists.push_back(hist);
      if (std::count(signals.begin(), signals.end(), name))
  ...
  else if (MODE == "SM3D" || MODE == "FCNCtug3d" || MODE == "FCNCtcg3d")
  {
    ...
    {
      fill_hist_3d("QCD", NBINS, rmin, rmax, &hists_to_save_3d, PREFIX_NTUPLES, FILES_QCD_MC, tree_name, vrule_x, vrule_y, vrule_z, qcd_selection, excl1, excl2, excl3);
    }
    for (auto channel : channel_other)
    {
    ...
    if (MODE == "FCNCtug3d")
      fill_hist_3d("fcnc_tug", NBINS, rmin, rmax, &hists_to_save_3d, PREFIX_NTUPLES, FILES_FCNC_TUG, tree_name, vrule_x, vrule_y, vrule_z, mc_selection, excl1, excl2, excl3);
    if (MODE == "FCNCtcg3d")
      fill_hist_3d("fcnc_tcg", NBINS, rmin, rmax, &hists_to_save_3d, PREFIX_NTUPLES, FILES_FCNC_TCG, tree_name, vrule_x, vrule_y, vrule_z, mc_selection, excl1, excl2, excl3);
    ...
    for (auto systematic : VARIATION_SYS_T2)
    {
      ...
      { // Ren, Fac, pdf (split by channels)
        ...
        { // Ren/Fac/pdf split for tW, DY, DB, s_ch, t_ch, ttbar
          for (auto channel : channel_other)
          {
            if (channel == sys)
            {
              ...
              fill_hist_3d_sys(channel + "_" + systematic + "_" + sys, NBINS, rmin, rmax, &hists_to_save_3d, PREFIX_NTUPLES, FILES_map.at(channel), tree_name, vrule_x, vrule_y, vrule_z, mc_selection, mc_selection, excl1, excl2, excl3);
          }
          for (auto channel : channel_wjets)
          {
          ...
          if (MODE == "FCNCtug3d")
            fill_hist_3d_sys("fcnc_tug_" + systematic + "_" + sys, NBINS, rmin, rmax, &hists_to_save_3d, PREFIX_NTUPLES, FILES_FCNC_TUG, tree_name, vrule_x, vrule_y, vrule_z, mc_selection_up, mc_selection_down, excl1, excl2, excl3);
          if (MODE == "FCNCtcg3d")
            fill_hist_3d_sys("fcnc_tcg_" + systematic + "_" + sys, NBINS, rmin, rmax, &hists_to_save_3d, PREFIX_NTUPLES, FILES_FCNC_TCG, tree_name, vrule_x, vrule_y, vrule_z, mc_selection_up, mc_selection_down, excl1, excl2, excl3);
        }
        for (auto channel : channel_wjets)
        { // Ren/Fac/pdf split for wjets
        ...
        if (MODE == "FCNCtug3d")
          fill_hist_3d_sys("fcnc_tug_" + systematic + "_Wjets", NBINS, rmin, rmax, &hists_to_save_3d, PREFIX_NTUPLES, FILES_FCNC_TUG, tree_name, vrule_x, vrule_y, vrule_z, mc_selection_up, mc_selection_down, excl1, excl2, excl3);
        if (MODE == "FCNCtcg3d")
          fill_hist_3d_sys("fcnc_tcg_" + systematic + "_Wjets", NBINS, rmin, rmax, &hists_to_save_3d, PREFIX_NTUPLES, FILES_FCNC_TCG, tree_name, vrule_x, vrule_y, vrule_z, mc_selection_up, mc_selection_down, excl1, excl2, excl3);
      }
      else
      {
        for (auto channel : channel_other)
      ...
      if (fprefix == "JER")
      {
        for (int i = 0; i < JER_SYS_NAMES.size(); i++)
        {
          ...
          for (int j = 0; j < 2; j++)
          {
            ...
            if (MODE == "FCNCtug3d")
              fill_hist_3d("fcnc_tug_" + sname, NBINS, rmin, rmax, &hists_to_save_3d, PREFIX_NTUPLES, FILES_FCNC_TUG, tree_name, vrule_x, vrule_y, vrule_z, mc_selection + extra_select, excl1, excl2, excl3);
            if (MODE == "FCNCtcg3d")
              fill_hist_3d("fcnc_tcg_" + sname, NBINS, rmin, rmax, &hists_to_save_3d, PREFIX_NTUPLES, FILES_FCNC_TCG, tree_name, vrule_x, vrule_y, vrule_z, mc_selection + extra_select, excl1, excl2, excl3);
          }
        }
      }
      else if (fprefix == "JEC")
    ...
    cout << __FILE__ " : unknow mode " << MODE << endl;
